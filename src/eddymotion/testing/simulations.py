...
def create_random_evals(size, rng):
    """Create eigenvalus drawn from a uniform distribution."""

    # lambda_2 = lambda_3 set according to Canales-Rodriguez, NIMG 184 2019,
...
def simulate_voxels(S0, hsph_dirs, bval_shell=1000, snr=20, n_voxels=1, evals=None, seed=None):
    ...
    if evals is None:
        _evals = create_random_evals(n_voxels, rng)
    else:
