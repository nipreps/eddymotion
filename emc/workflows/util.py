...
def init_dwi_reference_wf(omp_nthreads, name='dwi_reference_wf'):
    ...
    Workflow Graph
        .. workflow::
            ...
            from emc.workflows.dwi.util import init_dwi_reference_wf
    ...
    See also
    --------
    * :py:func:`~emc.workflows.dwi.util.init_enhance_and_skullstrip_wf`
...
def init_enhance_and_skullstrip_dwi_wf(
    ...
    Workflow Graph:
        .. workflow ::
            ...
            from emc.workflows.dwi.util import init_enhance_and_skullstrip_dwi_wf
